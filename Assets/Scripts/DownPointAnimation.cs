...
public class DownPointAnimation : MonoBehaviour
{
    public delegate void DownPointAnmEventHandler();
    public static event DownPointAnmEventHandler OnHammer;
    public static event DownPointAnmEventHandler OnMole;
    Animator animator;
    ...
    public void HammerPointAnimation()
    {
        ...
        {
            animator.SetTrigger("DownHammerPoint");
        }
    ...
    public void MolePointAnimation()
    {
        if (isCollision && gameType != 2)
        {
            animator.SetTrigger("DownMolePoint");
        }
        else if (isCollision && gameType == 2)
        {
            OnMole();
